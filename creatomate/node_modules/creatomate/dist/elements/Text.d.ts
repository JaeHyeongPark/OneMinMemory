import { Fill, Font, Stroke, StrokeCap, StrokeJoin, TextBackground, TextTransform, ValueOrKeyframes } from '../properties';
...
export declare class Text extends ElementBase<TextProperties> {
    type: string;
}
