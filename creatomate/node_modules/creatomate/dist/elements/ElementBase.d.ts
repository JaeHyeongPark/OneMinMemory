import { BlendMode, Blur, BlurMode, ColorFilter, ColorFilterType, MaskMode, Shadow, ValueOrKeyframes, Warp, WarpMode, WarpPoint } from '../properties';
...
export declare abstract class ElementBase<T extends ElementProperties> {
    properties: T;
